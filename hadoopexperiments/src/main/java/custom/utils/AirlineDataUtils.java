...
public class AirlineDataUtils {
    ...
    public static DelaysValue parseDelaysValue(String line) {

        String[] contents = line.split(",");
        DelaysValue dw = new DelaysValue();
    ...
    public static DelaysValue parseDelaysValueFromText(Text line) {
    ...
    public static Text parseDelaysValueToText(DelaysValue dw) {
    ...
    public static int getCustomPartition(MonthAndDayOfWeekKey key,int indexRange, int noOfReducers) {
